 ...
 * creation ...: 04.01.2007
 * revisions ..: $Id: ltiSplitImageToYCbCr.cpp,v 1.1 2007/01/05 03:29:42 alvarado Exp $
 */
...
namespace lti {
  ...
  // copy constructor
  splitImageToYCbCr::splitImageToYCbCr(const splitImageToYCbCr& other) {
    copy(other);
  }
  ...
  const char* splitImageToYCbCr::getTypeName() const {
    return "splitImageToYCbCr";
  }
  ...
  // clone member
  functor* splitImageToYCbCr::clone() const {
  ...
  bool splitImageToYCbCr::apply(const image& img,
                                channel& c1,
                                channel& c2,
                                channel& c3) const {
