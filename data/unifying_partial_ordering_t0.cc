...
void killer_check() {
	...
	typedef more::gen::unifying_partial_ordering
		    < int, more::gen::unify_to_first<int> >
		ordering;
	...
	*po.max() = -2;
	...
	check_antisymmetric(es.begin(), es.end(),
			    gen::adapt(&ordering::preceq),
			    gen::adapt(&ordering::eq));
...
void test_unify() {
    typedef more::gen::unifying_partial_ordering<int> ordering;
    typedef ordering::element element;
    ordering po;
    *po.min() = -1;
    *po.max() = -2;
    element e0a = po.insert(0);
    element e0b = po.insert(0);
    element e0c = po.insert(0);
    element e1a = po.insert(1);
    element e1b = po.insert(1);
    MORE_CHECK(po.constrain_preceq(e0a, e0b));
    MORE_CHECK(po.constrain_preceq(e0b, e0c));
    MORE_CHECK(po.constrain_preceq(e0a, e1a));
    MORE_CHECK(po.constrain_preceq(e0a, e0c));
    MORE_CHECK(po.constrain_preceq(e0c, e0a));
    MORE_CHECK(e0c == e0a);
    MORE_CHECK(preceq(e0c, e0a));
    MORE_CHECK(!po.constrain_eq(e1a, e0a));
}
...
//    typedef std::string string_type;
    typedef more::gen::unifying_partial_ordering
	< string_type, more::gen::unify_to_first<string_type> > ordering;
    typedef ordering::element element;
    ordering po;
    *po.min() = "minimum";
    *po.max() = "maximum";
    ...
    po.constrain_preceq(e_0, e_1_0);
    po.constrain_preceq(e_0, e_1_1);
    po.constrain_preceq(e_1_0, e_2);
    po.constrain_preceq(e_1_1, e_2);
    po.constrain_preceq(e_2, e_3);
    ...
    element e_2b = po.insert("2b");
    element e_2c = po.insert("2c");
    ...
    MORE_ECHO(po.constrain_eq(e_2, e_2b));
    MORE_ECHO(po.constrain_eq(e_2c, e_2));
    ...
    po.constrain_eq(e_2, e_0);
    MORE_CHECK(e_0 == e_1_0);
    MORE_CHECK(e_0 == e_1_1);
    MORE_CHECK(e_0 == e_2);
    MORE_CHECK(e_0 != e_3);
    MORE_CHECK(e_0 != po.min());
