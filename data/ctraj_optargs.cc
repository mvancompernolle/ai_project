  ...
  for (int i=0; optargs[i]!='\0'; i++) {
	...
	//ugly, but the desired character is already used...
      ...
      case ('S'):
        ...
        break;
      case ('t'):
        fprintf(fs, "  -t   source of wind fields\n");
        break;
      case ('T'):
      ...
      case ('U'):
        ...
        break;
      case ('V'):
        fprintf(fs, "  -V   type of velocity field [0]\n");
        fprintf(fs, "         0=2-D global, azimuthal equidistant projection\n");
        fprintf(fs, "         1=2-D, date-based time grid\n");
        fprintf(fs, "         2=analytical\n");
        break;
      case ('v'):
