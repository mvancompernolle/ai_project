/**
 *  @example mirror/example/meta_prog_10.cpp
...
// Helper functor class used by for_each_ii in print_private_members_of
struct name_printer
{
...
void print_private_members_of(void)
{
	...
	std::cout << "Private members of the '"
		<< MetaClass::full_name()
		<< "' class: ";
	mp::for_each_ii<
		mp::only_if<
...
/* Example of output:
Private members of the 'test::H' class:
Private members of the 'test::I' class: test::I::i.
Private members of the 'test::J' class: test::I::i.
*/
